...
//        addResume(name: "Bob", age: 25)
//        addResume(name: "Catter", age: 40)
//        updateResume(name: "Bob", age: 32)
//        for resume in fetchResume(name: "Bob") {
//            print(resume.name, resume.age)
//        }
        deleteAllResume()
        fetchCount()
    }
